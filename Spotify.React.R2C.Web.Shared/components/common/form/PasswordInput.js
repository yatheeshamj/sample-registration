...
//import { Pass } from '@material-ui/icons'

const PasswordInput = ({ label, id, field, hint, form: { touched, errors }, ...props }) => {
    ...
    return (
        <div className="form-group">
            ...
            <div className="input-group-addon">
                <a href=""><i className="fa fa-eye-slash password-eye" aria-hidden="true"></i></a>
            </div>
