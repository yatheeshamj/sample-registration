...
const footer = ({ width, footerConfig }) => {
    ...
    return <Fragment>
        <Translate>
            {({ translate }) => <div className="footers footer-banner top-spacing">
                <div
                    className={
                        classNames({
                    ...
                    <div className="footer-banner">
                        ...
                        <div className="footer-links">
                            {/* <a href={FooterLinks.FTC_NOTICE} rel="noopener noreferrer" target="_blank" className="FTC-Notice">{translate(`${CURRENT_SCREEN}.ftcNotice`)}</a>
                            &nbsp; | &nbsp; */}
