...
import ProfilePartialForm from './ProfilePartialForm';
...
class ProfilePartialFormContainer extends Component {
    state = {
...
export default connect(mapStateToProps, { createAgentProfile })(ProfilePartialFormContainer);
